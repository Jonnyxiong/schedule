...
public class UcpaasDateUtils {
	...
	public static void main(String[] args) {
		...
		System.out.println(UcpaasDateUtils.parseDate("2012-12-21 23:22:45", "yyyy-MM-dd HH:mm:ss"));
		System.out.println(UcpaasDateUtils.parseDate("2016-12-16 00:00:00.0", "yyyy-MM-dd HH:mm:ss"));
