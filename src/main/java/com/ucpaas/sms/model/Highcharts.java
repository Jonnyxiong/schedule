...
import com.ucpaas.sms.constant.ChartConstant.ChartType;
...
public class Highcharts implements Cloneable {
	...
	private ChartType chartType = ChartType.time;// 图表类型，默认是时间类型
	...
	private Long xMin;// x轴的最小值
	private Long yMin = 0L;// y轴的最小值，默认是0
	private Long xMax;// x轴的最大值
	private Long yMax;// y轴的最大值
	private boolean showDefault = true;// 是否显示默认值，默认是true
	private Long interval;// 相邻点的间隔时间，单位：毫秒
