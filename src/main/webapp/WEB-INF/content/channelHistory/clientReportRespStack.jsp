	...
	<div class="container-fluid">
		...
		<nav class="navbar navbar-success" role="navigation">
				<ul class="nav nav-tabs nav-justified" role="tablist">
					<li class="active"><a href="${ctx}/channelHistory/clientQuality/page">用户质量趋势分布图</a></li> 
				</ul>
		</nav>
		<div class="row-fluid">
			<div class="span12">
				<div class="widget-box">
					<div class="widget-title">
						...
						<div class="search">
							<ul> 
								<li>
									<u:select id="clientId" value="${clientId}" placeholder="用户账号" sqlId="findAllClientId" onChange="clientOnChange" excludeValue=""/>
								</li>
								<li>
...
var GET_REPORT_RESP_STACK_URL = "${ctx}/channelHistory/client/getReportRespStackData";
...
// 		return;
// 	}
	refreshAllEchartData(clientId, startTime, endTime);
...
function refreshAllEchartData(clientId, startTime, endTime){
	console.log("reresh stack...");
	var reqDataObj = {};
	reqDataObj.clientId = clientId;
...
function exportExcel(){
	...
	if(echartData.xAxisData.length == 0){
		...
		download("${ctx}/channelHistory/clientReportRespStack/exportExcel", "post");
	}
}
