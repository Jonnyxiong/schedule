...
import com.ucpaas.sms.service.admin.TaskService;
...
@Controller
@Scope("prototype")
@Results({ @Result(name = "query", location = "/WEB-INF/content/admin/task/query.jsp"),
		@Result(name = "view", location = "/WEB-INF/content/admin/task/view.jsp"),
		@Result(name = "edit", location = "/WEB-INF/content/admin/task/edit.jsp") })
