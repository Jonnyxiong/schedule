				...
				<div class="widget-box">
					...
					<div class="widget-title">
						...
						<div class="search" style="height:auto;">
						 <form method="post" id="mainForm" action="${ctx}/smsRecordMolog/query">
							<ul class="ul2">
								<li>
								...
								<li>
									<input type="text" name="tophone" value="<s:property value="#parameters.tophone"/>" onfocus="inputControl.setNumber(this, 60, 0, false)" placeholder="目的号码" class="txt_250" />
								</li>
								<li>
								...
								<li>
									<input type="text" name="channelsmsid" value="${param.channelsmsid}" placeholder="运营商上行短信ID" maxlength="100"/>
								</li>
								<li>
									<input type="text" name="clientid" value="${param.clientid}" placeholder="对应到的客户ID" maxlength="100"/>
								</li>
								<li>
						...
						<table class="table table-bordered table-striped">
							...
							<tbody>
								...
								<tr>
							      ...
							      <td>${phone}</td>
							      <td>${tophone}</td>
							      <td class="sms_status">${content}</td>
							      <td>${channelsmsid}</td>
							      <td>${clientid}</td>
							      <td>${mofee}</td>
							      <td>${chargetotal}</td>
