	...
	<div class="container-fluid">
		...
		<nav class="navbar navbar-success" role="navigation">
			<ul class="nav nav-tabs nav-justified" role="tablist">
				<li><a href="${ctx}/componentConf/mqConf/query?middleware_type=2">MQ_SEND_IO</a></li>
				<li><a href="${ctx}/componentConf/mqConf/query?middleware_type=1">MQ_C2S_IO</a></li>
				<li class="active"><a href="${ctx}/componentConf/mqConf/query?middleware_type=4">MQ_SEND_DB</a></li>
					...
					<div class="widget-title">
						...
						<div class="search">
						 	 <form method="post" id="mainForm" action="${ctx}/componentConf/mqConf/query">
								<ul>
									<li>
										<input type="hidden" name="middleware_type" value="4">
									</li>
									<li>
