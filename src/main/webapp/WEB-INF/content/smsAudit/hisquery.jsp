			...
			<div class="span12">
				<div class="widget-title">
					...
					<nav class="navbar navbar-success" role="navigation">
						<ul class="nav nav-tabs nav-justified" role="tablist">
							<li class="active"><a href="${ctx}/smsaudit/hisquery">过期短信查询</a></li>
							<li ><a href="${ctx}/smsaudit/hisbakquery">审核历史查询</a></li>
				...
				<div class="widget-box">
					...
					<div class="widget-title">
						...
						<h5></h5>
						<div class="search">
						 	 <form method="post" id="mainForm" action="${ctx}/smsaudit/hisquery">
						 	 	<div class="search">
									<ul>
										<li name="testhight1">
											<span>审核时间:</span>
...
function exportExcel() {
    ...
    mainForm.attr("action", "${ctx}/smsaudit/hisExportExcel").submit();
