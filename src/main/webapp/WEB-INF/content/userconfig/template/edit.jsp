...
<html>
<head>
	<title>${data.id==null?'添加':'修改'}模板</title>
	<style type="text/css">
		.select2-selection{
			width: 600px;
		}
          ...
          <div class="widget-content nopadding">
            <form class="form-horizontal" method="post" action="#" id="mainForm">
              <div class="control-group">
                ...
                <div class="controls">
                  <input type="text" name="templateid" value="${data.templateid}" onfocus="inputControl.setNumber(this, 9, 0, false)" />
...
<!-- 						</div> -->
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <input type="text" name="company" value="${data.company}" maxlength="60" />
                </div>
              </div>
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <input type="text" name="sign" value="${data.sign}" maxlength="30" />
                </div>
              </div>
...
//修改通道类型
function change_operatorstype(value, text){
	if(value==2){//联通
		$("#port, #node, #spid").attr("disabled", false);
	}else{
		$("#port, #node, #spid").val("").attr("disabled", true);
	}
}
